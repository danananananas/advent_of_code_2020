...
from day02.solution import read_pwd_line, check_sled_rental_pwd_policy, count_valid_pwds
...
class TestSolution(TestCase):
    ...
    def test_check_pwd_policy_example_1(self):
        ...
        self.assertTrue(check_sled_rental_pwd_policy(*test_instance))

    def test_check_pwd_policy_example_2(self):
        test_instance = (1, 3, 'b', 'cdefg')
        self.assertFalse(check_sled_rental_pwd_policy(*test_instance))
